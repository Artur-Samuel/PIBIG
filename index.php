...
if (!isset($_SESSION['usuario_id'])) {
   header("Location: Perfil/formlogin.html");
    exit();
}

require "Eventos/conexao.php";

//Deleta os Eventos antigos
$conn->query("DELETE FROM eventos WHERE data_evento < CURDATE() - INTERVAL 1 DAY");

// busca os proximos 4 eventos
$sqlEventos = "
    SELECT titulo, data_evento, imagem
    FROM eventos
...
<header class="site-header">
  ...
  <section class="banner">
    <div class="content container">
      ...
      <p>Uma Igreja em Movimento — 2026, Ano de ser e fazer Discipulos</p>
    ...
    <div class="grid">
        <?php while ($evento = $resultEventos->fetch_assoc()): ?>
            ...
            <div class="evento-card">
                <img src="eventos/uploads/<?= $evento['imagem'] ?>" 
                     alt="Imagem do evento"
                     onerror="this.src='imagens/default.jpg'">

                <div class="evento-info">
                    <h3><?= $evento['titulo'] ?></h3>
                    <p class="data"><?= date("d/m/Y", strtotime($evento['data_evento'])) ?></p>
                </div>
            </div>
